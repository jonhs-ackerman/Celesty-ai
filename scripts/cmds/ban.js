...
module.exports = {
	...
	langs: {
		...
		en: {
			notFoundTarget: "⚠️ | 𝐫𝐞𝐩𝐨𝐧𝐝𝐬 𝐚𝐮 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐝𝐞 𝐜𝐞𝐥𝐮𝐢 𝐪𝐮𝐞 𝐭𝐮 𝐯𝐞𝐮𝐱 𝐛𝐚𝐧𝐧𝐢𝐫",
			...
			cantSelfBan: "⚠️ | 𝐭'𝐞𝐬 𝐭𝐞𝐮𝐛é 𝐨𝐮 𝐪𝐮𝐨𝐢 🕵️‍♂️ 𝐣𝐞 𝐭𝐞 𝐩𝐞𝐫𝐦𝐞𝐭𝐬 𝐩𝐚𝐬 𝐝𝐞 𝐭𝐞 𝐛𝐚𝐧𝐧𝐢𝐫 𝐡𝐞𝐢𝐧",
			cantBanAdmin: "❌ |𝐨𝐧 𝐧𝐞 𝐛𝐚𝐧𝐧𝐢 𝐩𝐚𝐬 𝐮𝐧 𝐜𝐡𝐞𝐟 𝐡𝐨𝐨𝐨𝐨𝐨𝐨𝐨 🕵️‍♂️",
			existedBan: "❌ | This person has been banned before!",
			noReason: "No reason",
			bannedSuccess: "✅ | Banned %1 from box chat!",
			needAdmin: "⚠️ | 𝐥𝐞 𝐛𝐨𝐭 𝐚 𝐛𝐞𝐬𝐨𝐢𝐧𝐬 𝐝'𝐞𝐭𝐫𝐞 𝐧𝐨𝐦𝐦é 𝐚𝐝𝐦𝐢𝐧 𝐩𝐨𝐮𝐫 𝐬𝐮𝐩𝐩𝐫𝐢𝐦𝐞𝐫 𝐥𝐞𝐬 𝐩𝐞𝐫𝐝𝐨𝐧𝐧𝐞𝐬 𝐛𝐚𝐧𝐧𝐢𝐞𝐬 🕵️‍♂️ 𝐭𝐮 𝐚𝐬 𝐩𝐞𝐮𝐫 𝐝𝐞 𝐦𝐞 𝐧𝐨𝐦𝐦𝐞𝐫 🕵️‍♂️⁉️",
